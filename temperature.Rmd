...
If `sourceURL` is specified, `downloadData("temperature", "C:/Users/Tati/Documents/GitHub")` may be sufficient.
...
Provide a summary of user-visible parameters (Table \@ref(tab:moduleParams-temperature))
